        ...
        <div class="swiper banner__slider">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              ...
              <div
                class="slide-bg test-bg"
                data-background="src/assets/images/banner/server-cloud-data-storage-concept-cloudscape-digital-online-service-global-network-web-database-backup-computer-infrastructure-technology.jpg"
              ></div>
              <div class="container">
            ...
            <div class="swiper-slide">
              ...
              <div
                class="slide-bg test-bg"
                data-background="src/assets/images/banner/man-does-sf-online-consciousness-upload-trying-transcend-out-simulation.jpg"
              ></div>
              <div class="container">
                <div class="banner__content">
                  <h4
            ...
            <div class="swiper-slide">
              ...
              <div
                class="slide-bg test-bg"
                data-background="src/assets/images/banner/medium-shot-man-wearing-vr-glasses.jpg"
              ></div>
              <div class="container">
                <div class="banner__content">
                  <h4
